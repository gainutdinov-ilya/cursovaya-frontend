<template>
  ...
  <div v-if="show" class="login" id="loginBlock">
    <div class="box">
      ...
      <div class="loginBlock"><a class="button-login" href="/login">Личный кабинет</a>
        <div class="block"></div>
        <div class="text">
          <li>Уже</li>
          <li>бывали</li>
      ...
      <div class="registerBlock"><a class="button-register" href="#">Присоедениться</a>
        <div class="text">
          <li>если</li>
          <li>ещё не</li>
          <li>бывали</li>
...
.login .box .registerBlock .button-register {
  position: absolute;
  padding-left: 15px;
  padding-right: 15px;
  height: 65px;
...
.login .box .registerBlock .text li {
